...
public class Square extends AShape{
	...
	public Square(int x, int y, Color color, double  width,
	  double height,Stroke stroke, boolean filled) {
	...
	height = width;
	  ...
	  getx = location.x > secondPoint.x ? location.x - (int) width : location.x;
	  gety = location.y > secondPoint.y ?  location.y - (int)width : location.y;
	  g.setColor(color);
		g.setStroke(stroke);
	  if (getFilled()) {
